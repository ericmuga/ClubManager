    ...
    <div>
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex ">
                                ...
                                <NavLink :href="route('club-settings.index')" :active="route().current('club-settings.index')">
                                    Club Settings
                                </NavLink>
                            </div>
                        </div>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('dashboard')" :active="route().current('dashboard')">
                         ...
                         <ResponsiveNavLink :href="route('club-settings.index')" :active="route().current('club-settings.index')">
                            Club Settings
                        </ResponsiveNavLink>
                    </div>
            ...
            <header class="bg-white shadow dark:bg-gray-800" v-if="$slots.header">
                <div class="px-4 py-6 mx-auto my-3 text-center max-w-7xl sm:px-6 lg:px-8">
                    <slot name="header" />
                </div>
            </header>
